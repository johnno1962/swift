...
func garbage() -> () {
  ...
  return a + "a" // expected-note {{overloads for '+' exist with these partially matching parameter lists: (Int, Int), (String, String)}} expected-error{{binary operator '+' cannot be applied to operands of type 'Int' and 'String'}}
}
