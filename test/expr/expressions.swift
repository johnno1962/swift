...
func testSingleQuoteStringLiterals() {
  _ = 'abc' // expected-error{{single-quoted string literal found, use '"'}}{{7-12="abc"}}
    // expected-error@-1{{single-quoted string not single Character}}
  ...
  _ = 'ab\("c")' // expected-error{{single-quoted string literal found, use '"'}}{{7-17="ab\\("c")"}}
    // expected-error@-1{{single quoted literal cannot contain interpolations}}
    // expected-error@-2{{single-quoted string not single Character}}
